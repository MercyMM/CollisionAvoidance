...
cv::Mat drawFloatGraph2(std::deque<double> arraySrc, int nArrayLength DEFAULT(0), cv::Mat imageDst DEFAULT(cv::Mat(0,0, CV_8UC1)), float minV DEFAULT(0.0), float maxV DEFAULT(0.0), int width DEFAULT(0), int height DEFAULT(0), char *graphLabel DEFAULT(0), bool showScale DEFAULT(true));
